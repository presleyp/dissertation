...
okay. Try to remember the right answer, and you'll get better with practice. If
you pay attention and get the answers right enough of the time, you will get a
<b>bonus</b>.
<br><br>
...
catch_intro = '''Good job! Now we'll move onto a new kind of practice. You will
...
with make_experiment(IDGenerator()):
    ...
    def make_inner_blocks(singular_lexical,
        ...
        filler_n2 = 3
        block1 = Block(pages =
                singular_lexical[:stimuli_n1] +
                singular_number[:stimuli_n1] +
                other_singular_lexical[:stimuli_n1] +
                plural_lexical[:stimuli_n1] +
                plural_number[:stimuli_n1] +
                extra_plural[:stimuli_n1] +
                training_filler[:filler_n1],
            criterion = 0.8,
            cutoff = 3)
        block2 = Block(pages =
                singular_lexical[stimuli_n1:stimuli_n2] +
                singular_number[stimuli_n1:stimuli_n2] +
                other_singular_lexical[stimuli_n1:stimuli_n2] +
                plural_lexical[stimuli_n1:stimuli_n2] +
                plural_number[stimuli_n1:stimuli_n2] +
                extra_plural[stimuli_n1:stimuli_n2] +
                training_filler[filler_n1:filler_n2],
            criterion = 0.8,
            cutoff = 3),
        block3 = Block(pages =
                singular_lexical[stimuli_n2:] +
                singular_number[stimuli_n2:] +
                other_singular_lexical[stimuli_n2:] +
                plural_lexical[stimuli_n2:] +
                plural_number[stimuli_n2:] +
                extra_plural[stimuli_n2:] +
                training_filler[filler_n2:],
            criterion = 0.8,
            cutoff = 3)
    ...
    experiment = Experiment([
        intro_block,
        train_intro,
        lang1_block, lang2_block,
        precatch,
        voice_wug_block, nasal_wug_block,
        test_intro,
        test_block,
        precatch.new(),
        nasal_catch_block, voice_catch_block,
        demographics_block,
        outro_block],
    ...
    experiment.install('alternations_experiment_3')
